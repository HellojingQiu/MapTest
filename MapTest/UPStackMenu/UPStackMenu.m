...
- (id)initWithContentView:(UIView*)contentView
{
    ...
    if(self) {
        ...
        [_baseButton addConstraint:[NSLayoutConstraint constraintWithItem:contentView attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:_baseButton attribute:NSLayoutAttributeCenterX multiplier:1 constant:0]];
        [_baseButton addConstraint:[NSLayoutConstraint constraintWithItem:contentView attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:_baseButton attribute:NSLayoutAttributeCenterY multiplier:1 constant:0]];
